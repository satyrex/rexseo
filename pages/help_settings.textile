...
*** *Erstellungsdatum:* selbsterklärend..
*** *Änderungsdatum:* selbsterklärend..
...
Sofern in der Struktur (Kategorie/Artikelnamen), den Einstellugen von RexSEO, oder durch andere Addons Änderungen vorgenommen wurden, die zu geänderten URLs führen, werden diese Änderungen vom Addon automatisch erkannt und eine passende Weiterleitung eingerichtet. Als Verfallsdatum wird der Wert aus *Default Expire* verwendet.
* *robots.txt:*
