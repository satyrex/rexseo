...
$Parser->set_feed_url('http://www.gn2-code.de/projects/rexseo/repository/revisions.atom?key=2437c4f8172c5c6e0020a236b576d5128029451b');
$Parser->init();
...
foreach($Parser->get_items(0,50) as $item)
{
  ...
  if (substr($title,0,8)=="Revision")
  {
    ...
    echo '<span class="rexseo_date">'.$date.'</span><a class="jsopenwin" target="_blank" href="'.$id.'/diff'.'">'.$title.'</a>';
    echo '</div>';
  }
}
