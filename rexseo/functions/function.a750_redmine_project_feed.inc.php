...
if(!function_exists('a750_redmine_project_feed'))
{
  function a750_redmine_project_feed($project_root_url='',$key='',$func='')
  {
    global $REX;
    ...
    {
      return 'function redmine_project_feed(): missing input parameters..';
    }
  }
}
